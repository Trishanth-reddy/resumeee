  ...
  projects: [
    {
      ...
      date: "Spring 2023",
      descriptions: [
        "Created and launched a free resume builder web app that allows thousands of users to create professional resumes easily and land their dream jobs",
      ],
    },
  ],
  skills: {
